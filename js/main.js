...
const channels = [
    { id: '-ZDkdbPqUZg', name: 'COMO APRENDER LIBRAS SOZINHO DO ZERO' },
    { id: 'udWSfcwMgH4', name: 'CUMPRIMENTOS EM LIBRAS PARA INICIANTES mais usados (Língua de Sinais na Prática)' },
    { id: 'qkSfTWwds8c', name: '35 SINAIS DE LIBRAS BÁSICOS MAIS USADOS (LÍNGUA DE SINAIS)' },
    { id: '6zjYw96B2Lc', name: '5 FRASES EM LIBRAS PARA INICIANTES NA PRÁTICA (LÍNGUA DE SINAIS)' },
    { id: 'rSNb4zxoqvo', name: 'SINAIS DE PRONOMES EM LIBRAS: EU, VOCÊ, ELE, NÓS, ELES... | LÍNGUA DE SINAIS' },
    { id: '0LF6vgqDcVM', name: 'EXPRESSÕES FACIAIS NA LIBRAS: Para que servem e como usar? É careta?!' },
    { id: 'EeYsBNn5Mdk', name: 'Como Melhorar Minha Memória' }
];
